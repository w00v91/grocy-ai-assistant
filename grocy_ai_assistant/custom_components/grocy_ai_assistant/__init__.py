    ...
    async def add_product_via_ai_service(call):
        ...
        async with aiohttp.ClientSession(timeout=timeout) as session:
            try:
                ...
                grocy_url = "http://homeassistant.local:9192/api/objects/products"
                ...
                if image_b64 and new_id:
                    try:
                        ...
                        upload_url = f"http://homeassistant.local:9192/api/files/productpictures/{upload_path_b64}"
                        ...
                        if img_resp.status in [200, 201, 204]:
                            ...
                            update_url = f"http://homeassistant.local:9192/api/objects/products/{new_id}"
