...
- **Add-on (`grocy_ai_assistant/config.yaml`):** `8.0.52`
- **Integration (`grocy_ai_assistant/custom_components/grocy_ai_assistant/manifest.json`):** `8.0.52`
- **Integrationskonstante (`grocy_ai_assistant/custom_components/grocy_ai_assistant/const.py`):** `8.0.52`
